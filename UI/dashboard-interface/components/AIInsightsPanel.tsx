...
export function AIInsightsPanel({ initialInsights }: { initialInsights: Insight[] }) {
    ...
    <div>
      <div className="flex items-center justify-between mb-8 gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Recommendations generated from your real click data</p>
        </div>
      ...
      <form onSubmit={ask} className="mb-8 flex gap-2">
        <input
          ...
          placeholder="Ask about your best channel, timing, or devices..."
      ...
      {answer && (
        <div className="mb-6 rounded-xl border border-primary/30 bg-primary/5 p-4 text-sm">{answer}</div>
      )}
